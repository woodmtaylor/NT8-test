    ...
    public partial class DiscordMessenger : Indicator
    {
        ...
        protected override void OnStateChange()
        {
            ...
            else if (State == State.Configure)
            {
                ...
                Account account = Account.All.FirstOrDefault(delegate(Account a) { return a.Name == AccountName; });
        ...
        {
            if (string.IsNullOrEmpty(WebhookUrls))
            {
            ...
            else
            {
                ...
                string[] splitUrls = WebhookUrls.Split(',');
                foreach (string url in splitUrls)
                {
                    urls.Add(url.Trim());
                }
                return urls;
