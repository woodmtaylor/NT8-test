...
namespace NinjaTrader.Custom.AddOns.DiscordMessenger.Services
{
    ...
    {
        private readonly NinjaTrader.Custom.AddOns.DiscordMessenger.Events.EventLoggingEvents _eventLoggingEvents;
        private List<EventLog> _eventLogs = new List<EventLog>();

        public EventLoggingService(NinjaTrader.Custom.AddOns.DiscordMessenger.Events.EventLoggingEvents eventLoggingEvents)
        {
